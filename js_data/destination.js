...
let destination = {
    ...
    country: {
        USA: {
            ...
            level_4: {
                destination_cost_0: [1420, 1920, 1430, 1480, 2500],
                destination_cost_1: [1300, 2020, 1300, 1340, 2580],
                destination_cost_2: [1310, 1890, 1325, 1375, 2525],
                destination_cost_3: [1420, 2040, 1540, 1480, 2530]
            }
        },
        CANADA: {
            level_1: {
                destination_cost_0: [1500],
                destination_cost_1: [1450],
                destination_cost_2: [1450],
                destination_cost_3: [1500]
            },
            level_2: {
                destination_cost_0: [1350],
                destination_cost_1: [1300],
                destination_cost_2: [1300],
                destination_cost_3: [1350]
            },
            level_3: {
                destination_cost_0: [1250],
                destination_cost_1: [1200],
                destination_cost_2: [1200],
                destination_cost_3: [1250]
            },
            level_4: {
                destination_cost_0: [1900],
                destination_cost_1: [1850],
                destination_cost_2: [1850],
                destination_cost_3: [1900]
            }
        }
    }
};